...
//                            * Question No 18 *
//____________________________________________________________________________________
var places = ['Dubai', 'Paris', 'United State', 'Rome', 'Egypt', 'Pakistan']; //1• orignal stored location
...
console.log(places.slice().sort(function (a, b) { return b.localeCompare(a); })); //5• reverse alphabetical order (without modifying)
...
console.log(places.sort(function (a, b) { return b.localeCompare(a); })); //9• sorted arrays in alphabetical and print them
console.log(places.sort(function (a, b) { return a.localeCompare(b); })); //10• sorted in reverse alphabetical order
